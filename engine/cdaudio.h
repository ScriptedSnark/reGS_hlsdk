#ifdef CDAUDIO_H_RECURSE_GUARD
#error Recursive header files inclusion detected in cdaudio.h
#else //CDAUDIO_H_RECURSE_GUARD

#define CDAUDIO_H_RECURSE_GUARD

#ifndef CDAUDIO_H_GUARD
#define CDAUDIO_H_GUARD
#pragma once
...
#endif //CDAUDIO_H_GUARD

#undef CDAUDIO_H_RECURSE_GUARD
#endif //CDAUDIO_H_RECURSE_GUARD